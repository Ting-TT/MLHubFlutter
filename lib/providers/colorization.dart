/// Help with retaining the state of the colorization process.
///
...
class ColorizationNotifier extends StateNotifier<ColorizationState> {
  ColorizationNotifier() : super(ColorizationState());
...
final colorizationStateProvider =
    StateNotifierProvider<ColorizationNotifier, ColorizationState>(
  (ref) => ColorizationNotifier(),
);
